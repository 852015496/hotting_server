package com.hetting.hottable.export;
...
public class ExportUtils {
    ...
    public static <T> void export(String excelName, List<T> list, LinkedHashMap<String, String> fieldMap, HttpServletResponse response) {
        ...
        try {
            ...
            // 填充工作表
            fillSheet(sheet, list, fieldMap, style,dateStyle);
            //将文件输出
    ...
    public static <T> void fillSheet(HSSFSheet sheet, List<T> list,
                                     LinkedHashMap<String, String> fieldMap, HSSFCellStyle style, CellStyle dateStyle) throws Exception {
        ...
        for (int index = 0; index < list.size(); index++) {
            ...
            for (int i = 0; i < enFields.length; i++) {
                ...
                if (objValue instanceof String ){
                    ...
                    HSSFCell cell = row.createCell(i);
                    cell.setCellValue(Integer.valueOf(objValue.toString()));
                }else if (objValue instanceof  Date){
                    Date objValue1 = (Date) objValue;
                    HSSFCell cell = row.createCell(i);
                    cell.setCellValue(objValue1);
