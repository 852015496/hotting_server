...
import com.hetting.hottable.mqttEMQ.callBack.PitpatCallback;
...
@Component
public class ConcentPitpatClient {

    private Logger log = Logger.getLogger(ConcentPitpatClient.class);

    private static final Logger logger = Logger.getLogger(ConcentPitpatClient.class);

//    public static final String HOST = "tcp://192.168.18.120:61613";
    public static final String TOPIC = "/edge/online";
...
//            options.setPassword(passWord.toCharArray());
            ...
            // 设置回调
            try{
                client.setCallback(new PitpatCallback());
    ...
    public static void subscribe(){
        ConcentPitpatClient client = new ConcentPitpatClient();
        client.start();
